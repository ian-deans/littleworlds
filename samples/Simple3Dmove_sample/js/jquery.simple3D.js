...
(function($, undefined){
    // jquery constructor
	$.prototype.simple3D = function(options){
		
		var thisObj = this;
				
		var opts = $.extend({}, $.prototype.simple3D.defaults, options );
	...
	return this;		
	 ...
	 // jquery constructor implementation defaults
	$.prototype.simple3D.defaults = {
		moveX: 12 ,
		moveY: 3 ,
		bgImage: false,
		targetAll: false,
